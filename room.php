                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="room-item shadow rounded overflow-hidden">
                                    <div class="position-relative">
                                        <?php if(!isset($hotel['file_upload']) || file_exists("uploads/hotels/".$hotel['file_upload'])){
                                            ?>
                                            <img class="img-fluid image_room" src="uploads/hotels/<?php echo $hotel['file_upload']; ?>" alt="">
                                            <?php
                                        }else{
                                            ?>
                                            <img class="img-fluid image_room" src="uploads/hotels/placeholder.jpg" alt="">
                                            <?php
                                        } ?>
                                        
                                        <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">&#8377;<?php echo $hotel['price']; ?>/Night</small>
                                    </div>
                                    <div class="p-4 mt-2">
                                        <div class="d-flex justify-content-between mb-3">
                                            <h5 class="mb-0"><?php echo $hotel['hotel_name']; ?></h5>
                                        </div>
                                        <div class="d-flex mb-3">
                                            <small class="border-end me-3 pe-3"><i class="fa fa-bed text-primary me-2"></i><?php echo $hotel['bed'] ?></small>
                                            <small class="border-end me-3 pe-3"><i class="fa fa-bath text-primary me-2"></i><?php echo $hotel['hotel_ac_noac'] ?></small>
                                            <small><i class="fa fa-wifi text-primary me-2"></i>Wifi</small>
                                        </div>
                                        <p class="text-body mb-3"><?php echo $hotel['detail'] ?></p>
                                        <hr>
                                        <p class="text-body mb-3"><?php echo $hotel['address'] ?></p>
                                        <div class="d-flex justify-content-center">
                                            <a class="btn btn-sm btn-dark rounded py-2 px-4" href="book-hotel.php?id=<?php echo $hotel['id']; ?>">Book Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
